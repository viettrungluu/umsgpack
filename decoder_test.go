...
var nonDefaultOptsUnmarshalTestCases = []unmarshalTestCase{
	// extension type (unsupported):
	// - ext 8:
	{encoded: []byte{0xc7, 0x00, 0x07}, err: UnsupportedExtensionTypeError},
	{encoded: []byte{0xc7, 0x01, 0x00, 0x42}, err: UnsupportedExtensionTypeError},
	{encoded: []byte{0xc7, 0x02, 0x80, 0x42, 0x43}, err: UnsupportedExtensionTypeError},
	{encoded: append([]byte{0xc7, 0xff, 0x7f}, fillerBytes(255)...), err: UnsupportedExtensionTypeError},
	// - ext 16:
	{encoded: []byte{0xc8, 0x00, 0x00, 0x07}, err: UnsupportedExtensionTypeError},
	{encoded: []byte{0xc8, 0x00, 0x01, 0x00, 0x42}, err: UnsupportedExtensionTypeError},
	{encoded: []byte{0xc8, 0x00, 0x02, 0x80, 0x42, 0x43}, err: UnsupportedExtensionTypeError},
	{encoded: append([]byte{0xc8, 0xff, 0xff, 0x7f}, fillerBytes(65535)...), err: UnsupportedExtensionTypeError},
	// - ext 32:
	{encoded: []byte{0xc9, 0x00, 0x00, 0x00, 0x00, 0x07}, err: UnsupportedExtensionTypeError},
	{encoded: []byte{0xc9, 0x00, 0x00, 0x00, 0x01, 0x00, 0x42}, err: UnsupportedExtensionTypeError},
	{encoded: []byte{0xc9, 0x00, 0x00, 0x00, 0x02, 0x80, 0x42, 0x43}, err: UnsupportedExtensionTypeError},
	{encoded: append([]byte{0xc9, 0x00, 0x01, 0x86, 0xa0, 0x7f}, fillerBytes(100000)...), err: UnsupportedExtensionTypeError},
	// - fixext 1
	{encoded: []byte{0xd4, 0x00, 0x00}, err: UnsupportedExtensionTypeError},
	// - fixext 2
	{encoded: []byte{0xd5, 0x00, 0x00, 0x01}, err: UnsupportedExtensionTypeError},
	// - fixext 4
	{encoded: []byte{0xd6, 0x00, 0x00, 0x01, 0x02, 0x03}, err: UnsupportedExtensionTypeError},
	// - fixext 8
	{encoded: []byte{0xd7, 0x00, 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07}, err: UnsupportedExtensionTypeError},
	// - fixext 16
	{encoded: []byte{0xd8, 0x00, 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f}, err: UnsupportedExtensionTypeError},
	// unsupported map key types (via fixmap):
	...
	// (unsupported extension type keys now fail due to that!)
	{encoded: []byte{0x81, 0xc7, 0x00, 0x07, 0x2a}, err: UnsupportedExtensionTypeError},
	{encoded: []byte{0x81, 0xc8, 0x00, 0x00, 0x07, 0x2a}, err: UnsupportedExtensionTypeError},
	{encoded: []byte{0x81, 0xc9, 0x00, 0x00, 0x00, 0x00, 0x07, 0x2a}, err: UnsupportedExtensionTypeError},
	{encoded: []byte{0x81, 0xd4, 0x00, 0x00, 0x2a}, err: UnsupportedExtensionTypeError},
	{encoded: []byte{0x81, 0xd5, 0x00, 0x00, 0x01, 0x2a}, err: UnsupportedExtensionTypeError},
	{encoded: []byte{0x81, 0xd6, 0x00, 0x00, 0x01, 0x02, 0x03, 0x2a}, err: UnsupportedExtensionTypeError},
	{encoded: []byte{0x81, 0xd7, 0x00, 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x2a}, err: UnsupportedExtensionTypeError},
	{encoded: []byte{0x81, 0xd8, 0x00, 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f, 0x2a}, err: UnsupportedExtensionTypeError},
	// duplicate keys (via fixmap):
